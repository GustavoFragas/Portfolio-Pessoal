    ...
    <section id="education" className="py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-green-500 to-blue-600" />

          <div className="space-y-12">
            {educations.map((edu) => (
              <div key={edu.id} className="relative pl-20 group">
                <div className={`absolute left-5 top-2 w-6 h-6 rounded-full ${
                  edu.isCurrent 
                    ? 'bg-gradient-to-r from-green-500 to-blue-600 animate-pulse' 
                    : 'bg-gray-600'
                }`} />
                
                <div className="bg-gray-800 rounded-lg p-6 hover:scale-105 hover:shadow-xl hover:shadow-green-500/20 transition-all duration-300">
                  ...
                  <p className="text-gray-400 leading-relaxed mb-3">{edu.description}</p>
                  {edu.isCurrent && (
                    <span className="inline-block px-3 py-1 bg-green-500/20 text-green-400 rounded-full text-sm mr-3">
                      Em Andamento
                    </span>
                  )}
                  <a

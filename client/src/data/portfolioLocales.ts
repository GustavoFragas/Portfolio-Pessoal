...
const ptUi = {
  ...
  hero: {
    ...
    portraitAlt: 'Gustavo Fragas Cunha sorrindo em frente ao painel da AWS durante o AWS Summit São Paulo.',
...
const enUi = {
  ...
  hero: {
    ...
    portraitAlt: 'Gustavo Fragas Cunha smiling in front of an AWS display at AWS Summit São Paulo.',
...
const esUi = {
  ...
  hero: {
    ...
    portraitAlt: 'Gustavo Fragas Cunha sonriendo frente a un panel de AWS durante AWS Summit São Paulo.',
